...
/// Marks the module entry symbol visible past the module boundary:
/// dllexport on Windows, default ELF/Mach-O visibility elsewhere. The module
/// targets build with hidden visibility, so this attribute is what keeps
/// ss_module_entry findable by dlsym/GetProcAddress.
#if defined(_WIN32)
