// Unit tests for the pure logic of the Windows platform layer: the region
// geometry (region_geometry.cpp), the UTF-8/UTF-16 conversions, and the
// display-id parsing. The Win32-coupled parts of the layer - DXGI capture,
// the GDI+ overlays, WinRT face detection, window enumeration - need a real
// desktop and are exercised by running the application, not here.
